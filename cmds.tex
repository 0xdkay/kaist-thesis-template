...
% evaluation keywords
% mm = mismatch
\newcommand{\unknownmm}{\textit{Unknown}\xspace}
\newcommand{\invalidmm}{\textit{Invalid}\xspace}
\newcommand{\missingmm}{\textit{Missing}\xspace}

\newcommand{\protlist}{\cc{Protocol List}\xspace}
\newcommand{\msglist}{\cc{Msg List}\xspace}
\newcommand{\msgie}{\cc{Msg IE List}\xspace}
\newcommand{\globalie}{\cc{Global IE List}\xspace}


\newcommand{\numbugs}{9\xspace}
\newcommand{\idapro}{IDA Pro\xspace}

\newcommand{\vendorone}{\cc{Vendor$_1$}\xspace}
\newcommand{\vendortwo}{\cc{Vendor$_2$}\xspace}
%\addtolength{\parskip}{-.17em}
...
\newenvironment{timeitemize}[3][]
{
  ...
  %\begin{itemize}[leftmargin=1.5em,itemsep=-0.4em,parskip=0em,topsep=-0.4em]
  \begin{itemize}[topsep=-1pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=1.5em]
  %\begin{itemize}[topsep=-1pt,leftmargin=1.5em]
      \small
